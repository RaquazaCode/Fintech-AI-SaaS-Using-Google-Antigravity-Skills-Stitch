...
export default function HeaderBar({
    ...
    return (
        <header className="h-[72px] bg-bg-primary border-b border-border-primary flex items-center justify-between px-8">
            {/* Left Section - Portfolio Stats */}
            <div className="flex items-center gap-8">
                {/* Account Selector */}
                <div className="flex items-center gap-2 cursor-pointer hover:bg-bg-elevated rounded-lg px-3 py-2 transition-colors">
